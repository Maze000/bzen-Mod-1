      ...
      <section id="isapres" className="py-20 bg-gradient-healing">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 fade-in">
            ...
            <p className="text-body text-text-secondary max-w-3xl mx-auto">
              Trabajamos con las principales ISAPRES de Chile para facilitar tu acceso 
              a nuestros servicios de salud mental y terapias complementarias.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-12">
            {isapres.map((isapre, index) => (
              <div
                key={isapre.name}
                                 className="bg-white/80 backdrop-blur-sm rounded-radius-lg p-6 shadow-card hover:shadow-healing transition-all duration-300 slide-in-up"
          ...
          <div className="text-center">
            <div className="bg-white/90 backdrop-blur-sm rounded-radius-lg p-8 max-w-2xl mx-auto shadow-card">
